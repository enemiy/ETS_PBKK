...
namespace AirlineTuto
{
    public partial class ViewPassenger : Form
    {
        ...
        SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP\source\repos\ETS-PBKK\Database\AirlineDb.mdfIntegrated Security=True;Connect Timeout=30");
        int key = 0;
        ...
        private void PassportTb_OnValueChanged(object sender, EventArgs e)
        {

        }

        private void PassAdd_OnValueChanged(object sender, EventArgs e)
        {

        }

        private void PassName_OnValueChanged(object sender, EventArgs e)
        {
