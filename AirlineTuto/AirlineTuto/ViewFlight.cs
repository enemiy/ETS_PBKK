...
namespace AirlineTuto
{
    public partial class ViewFlight : Form
    {
        ...
        SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP\source\repos\ETS-PBKK\Database\AirlineDb.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        private void FcodeTb_OnValueChanged(object sender, EventArgs e)
        {
